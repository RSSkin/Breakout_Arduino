...
#define LCD_CS A10 // Chip Select goes to Analog 3
#define LCD_CD A11 // Command/Data goes to Analog 2
#define LCD_WR A12 // LCD Write goes to Analog 1
#define LCD_RD A13 // LCD Read goes to Analog 0
#define LCD_RESET A9 // Can alternately just connect to Arduino's reset pin
...
const int16_t XP = 40, XM = A11, YP = A12, YM = 42; //240x320 ID=0x9341
const int16_t TS_LEFT = 122/*170*/, TS_RT = 929/*776*/, TS_TOP = 77/*201*/, TS_BOT = /*884*/889;
